...
<div class="am-container">
    <ol class="am-breadcrumb am-breadcrumb-slash">
        ...
        <li><a href="#">项目</a></li>
        <li class="am-active">栗子志愿</li>
    </ol>
    <div class="am-g">
        <div class="am-u-lg-8">
            <section class="am-panel am-panel-default">
                <header class="am-panel-hd">
                    <h2 class="am-panel-title">栗子志愿</h2>
                </header>
        ...
        <div class="am-u-lg-4">
            <ul class="am-list am-list-border">
                <li><a href="#"><i class="am-icon-github"></i>github：栗子志愿Code</a></li>
                <li><a href="#"><i class="am-icon-envelope"></i>123@123.com</a></li>
                <li><a href="#"><i class="am-icon-edge"></i>栗子志愿</a></li>
            </ul>
        </div>
    </div>
</div>
